...
import com.cardovip.dko.log.klog.BaseLog;
import com.cardovip.dko.log.klog.FileLog;
import com.cardovip.dko.log.klog.JsonLog;
import com.cardovip.dko.log.klog.XmlLog;
...
public final class log {
    ...
    private static void printStackTrace() {
        ...
        for (String trace : traceString) {
            if (trace.contains("at com.socks.library.log")) {
                continue;
            }
